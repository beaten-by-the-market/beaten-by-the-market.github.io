---
layout: single
title:  "나스닥에 몰렸던 19시 50분 거래정지의 정체는 주식병합이었습니다"
categories: 미국시장
...
지난 글에서 나스닥의 뉴스 거래정지 927건을 세어보니 **537건(57.9%)이 밤 7시 50분 정각**{: style="color: #4682B4;"}에 걸려 있었습니다. 그리고 그중 526건이 다음 거래일 아침 9시 정각에 일제히 풀렸습니다.
...
### 병합은 열흘 전부터 예고되어 있습니다

정지가 전건에 걸릴 수 있는 것은 **나스닥이 병합 일정을 미리 알고 있기 때문**{: style="color: #4682B4;"}입니다. 뉴스와 달리 병합은 돌발 사건이 아닙니다. 나스닥이 2025년에 상장기업에 낸 안내가 그 절차를 적어 두었습니다.

| 시점 | 무엇을 |
|---|---|
| 효력일 **10일 전** 정오까지 | 회사가 나스닥에 신고 (`5250(e)(7)`, 기업행위 신고 서식) |
| 효력일 **2영업일 전** 정오까지 | 회사가 공개 공시 (`5250(b)(4)`) |
| 공시 뒤 | **나스닥이 Daily List와 Equity Corporate Action Alert 발행** |
| 효력일 전날 19:50 | 거래정지 → 다음 날 09:00 재개 |

세 번째 줄이 이 글의 출발점이었습니다. **앞에서 티커와 날짜로 대조한 그 기업행위 공지**{: style="color: #4682B4;"}가 바로 이 단계에서 나옵니다. 1,230건이 공지와 붙은 것은 우연이 아니라 **회사가 열흘 전에 신고하고 나스닥이 그것을 시장에 알린 결과**입니다.

> 통지·공시 요건을 어기거나 병합 비율·시각을 부정확하게 공개하면 **나스닥이 거래를 정지한다**고 같은 안내가 적고 있습니다. 다만 그것은 **준수 위반에 대한 별개의 정지**이고, 이 글이 세는 19시 50분 정지는 요건을 지킨 회사에도 예외 없이 걸리는 정례 절차입니다.
...
**2021년(27건) 한 해만 뚝 떨어지고 나머지는 꾸준히 증가**{: style="color: #4682B4;"}하고 있습니다. 2021년이 왜 그렇게 낮았는지는 이 자료로 답할 수 없습니다. 밈주식·SPAC 강세로 1달러 밑 종목이 줄었다는 설명도, 코로나 시기 상장유지 요건 유예의 여파라는 설명도 가능하지만, **둘을 갈라 보려면 그해에 1달러 밑이던 종목이 몇이었는지를 알아야 하고 우리가 가진 것은 주가가 아니라 기업행위 공지**{: style="color: #4682B4;"}입니다. 특히 2026년은 7개월 만에 380건인데, 같은 속도면 연 651건으로 **5년 연속 사상 최고**{: style="color: #4682B4;"}입니다.
...
그런데 아직 설명하지 않은 것이 남아 있습니다. 1편에서 본 나스닥 뉴스 정지 927건 중 19시 50분은 537건이었습니다. **나머지 390건**{: style="color: #4682B4;"}은 주식병합이 아닙니다. 그 390건도 06시 55분, 07시 55분처럼 정각에 몰려 있었습니다.

이쪽은 진짜 뉴스 정지입니다. 회사가 인수합병이나 임상 결과를 발표하기 직전에 걸리는 것입니다. 그런데 **진짜 뉴스인데도 시각이 시계에 맞춰져 있습니다.**{: style="color: #4682B4;"} 다음 편에서 이 390건이 각각 무슨 발표였는지, 그리고 왜 06시 55분인지를 보겠습니다.
